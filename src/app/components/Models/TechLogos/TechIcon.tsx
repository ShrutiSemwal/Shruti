...
// - Optimally tweaks the material (like setting a white color on a specific mesh)
...
const TechIcon = ({ model }: IconProps) => {
  ...
  return (
    ...
    */}
      <Float speed={5.5} rotationIntensity={0.5} floatIntensity={0.9}>
        <group scale={model.scale} rotation={model.rotation ?? [0, 0, 0]}>
